...
par(mfrow = c(2, 2))
plot(totime,power_data$Global_active_power, type="l",xlab="",ylab="Global Active Power")
plot(totime,power_data$Voltage, type="l",xlab="datetime",ylab="Voltage")
...
plot(totime,power_data$Global_reactive_power, type="l",xlab="datetime",ylab="Global_reactive_power")
